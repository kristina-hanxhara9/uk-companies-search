/**
 * UK SIC Codes Data
 * Standard Industrial Classification codes used by Companies House
 */
const SIC_CODES = [
    { code: "01110", description: "Growing of cereals and other crops" },
    { code: "01120", description: "Growing of rice" },
    { code: "01130", description: "Growing of vegetables, fruits and nuts" },
    ...
    { code: "01190", description: "Growing of other crops" },
    { code: "01210", description: "Farming of cattle" },
    { code: "01220", description: "Other animal farming" },
    { code: "01230", description: "Mixed farming" },
    { code: "01240", description: "Agricultural services" },
    { code: "01250", description: "Hunting" },
    { code: "01300", description: "Hunting and related service activities" },
    ...
    { code: "10710", description: "Manufacture of bread" },
    { code: "10720", description: "Manufacture of rusks and biscuits" },
    { code: "10730", description: "Manufacture of macaroni, noodles, couscous" },
    { code: "10810", description: "Manufacture of sugar" },
    { code: "10820", description: "Manufacture of cocoa, chocolate and sugar confectionery" },
    { code: "10830", description: "Processing of tea and coffee" },
    ...
    { code: "10860", description: "Manufacture of homogenised food preparations" },
    { code: "10890", description: "Manufacture of other food products" },
    ...
    { code: "11070", description: "Manufacture of soft drinks" },
    ...
    { code: "13920", description: "Manufacture of made-up textile articles" },
    { code: "13930", description: "Manufacture of carpets and rugs" },
    { code: "13940", description: "Manufacture of cordage, rope, twine and netting" },
    { code: "13950", description: "Manufacture of non-wovens and articles made from non-wovens" },
    { code: "13960", description: "Manufacture of other technical and industrial textiles" },
    { code: "13990", description: "Manufacture of other textiles" },
    { code: "14110", description: "Manufacture of leather clothes" },
    { code: "14120", description: "Manufacture of workwear" },
    { code: "14130", description: "Manufacture of other outerwear" },
    { code: "14140", description: "Manufacture of underwear" },
    ...
    { code: "16290", description: "Manufacture of other products of wood" },
    { code: "17110", description: "Manufacture of pulp" },
    { code: "17120", description: "Manufacture of paper and paperboard" },
    { code: "17210", description: "Manufacture of corrugated paper and paperboard" },
    ...
    { code: "17290", description: "Manufacture of other articles of paper and paperboard" },
    ...
    { code: "20300", description: "Manufacture of paints, varnishes and similar coatings" },
    ...
    { code: "20590", description: "Manufacture of other chemical products" },
    ...
    { code: "23320", description: "Manufacture of bricks, tiles and construction products" },
    ...
    { code: "23490", description: "Manufacture of other ceramic products" },
    ...
    { code: "24200", description: "Manufacture of tubes, pipes, hollow profiles and related fittings" },
    ...
    { code: "25290", description: "Manufacture of other tanks, reservoirs and containers" },
    { code: "25300", description: "Manufacture of steam generators" },
    { code: "25400", description: "Manufacture of weapons and ammunition" },
    { code: "25500", description: "Forging, pressing, stamping and roll-forming of metal" },
    ...
    { code: "26309", description: "Manufacture of other communication equipment" },
    { code: "26400", description: "Manufacture of consumer electronics" },
    { code: "26510", description: "Manufacture of instruments for measuring, testing" },
    { code: "26520", description: "Manufacture of watches and clocks" },
    { code: "26600", description: "Manufacture of irradiation, electromedical equipment" },
    ...
    { code: "28140", description: "Manufacture of other taps and valves" },
    ...
    { code: "28230", description: "Manufacture of office machinery and equipment" },
    ...
    { code: "28302", description: "Manufacture of other agricultural and forestry machinery" },
    ...
    { code: "28920", description: "Manufacture of machinery for mining, quarrying" },
    { code: "28930", description: "Manufacture of machinery for food, beverage processing" },
    { code: "28940", description: "Manufacture of machinery for textile, apparel production" },
    ...
    { code: "30990", description: "Manufacture of other transport equipment" },
    ...
    { code: "32990", description: "Other manufacturing" },
    ...
    { code: "42220", description: "Construction of utility projects for electricity" },
    ...
    { code: "43999", description: "Other specialised construction activities" },
    ...
    { code: "45400", description: "Sale, maintenance and repair of motorcycles" },
    { code: "46110", description: "Agents involved in the sale of agricultural raw materials" },
    { code: "46120", description: "Agents involved in the sale of fuels, ores, metals and chemicals" },
    { code: "46130", description: "Agents involved in the sale of timber and building materials" },
    { code: "46140", description: "Agents involved in the sale of machinery, equipment" },
    { code: "46150", description: "Agents involved in the sale of furniture, household goods" },
    { code: "46160", description: "Agents involved in the sale of textiles, clothing, fur, footwear" },
    { code: "46170", description: "Agents involved in the sale of food, beverages and tobacco" },
    { code: "46180", description: "Agents specialised in the sale of other particular products" },
    ...
    { code: "46520", description: "Wholesale of electronic and telecommunications equipment" },
    ...
    { code: "46640", description: "Wholesale of machinery for the textile industry" },
    ...
    { code: "46740", description: "Wholesale of hardware, plumbing and heating equipment" },
    ...
    { code: "47240", description: "Retail sale of bread, cakes, flour confectionery" },
    ...
    { code: "47410", description: "Retail sale of computers, peripheral units and software" },
    { code: "47421", description: "Retail sale of mobile telephones" },
    { code: "47429", description: "Retail sale of telecommunications equipment" },
    { code: "47430", description: "Retail sale of audio and video equipment" },
    { code: "47510", description: "Retail sale of textiles" },
    { code: "47520", description: "Retail sale of hardware, paints and glass" },
    { code: "47530", description: "Retail sale of carpets, rugs, wall and floor coverings" },
    ...
    { code: "47599", description: "Retail of furniture, lighting, and similar" },
    { code: "47610", description: "Retail sale of books" },
    { code: "47620", description: "Retail sale of newspapers and stationery" },
    { code: "47630", description: "Retail sale of music and video recordings" },
    { code: "47640", description: "Retail sale of sports goods" },
    { code: "47650", description: "Retail sale of games and toys" },
    { code: "47710", description: "Retail sale of clothing" },
    { code: "47721", description: "Retail sale of footwear" },
    { code: "47722", description: "Retail sale of leather goods" },
    { code: "47730", description: "Dispensing chemist" },
    { code: "47741", description: "Retail sale of hearing aids" },
    { code: "47749", description: "Retail sale of medical and orthopaedic goods" },
    { code: "47750", description: "Retail sale of cosmetic and toilet articles" },
    { code: "47760", description: "Retail sale of flowers, plants, seeds, fertilisers" },
    { code: "47770", description: "Retail sale of watches and jewellery" },
    { code: "47781", description: "Retail sale of computers, peripheral units and software" },
    { code: "47782", description: "Retail sale by opticians" },
    { code: "47789", description: "Other retail sale of new goods in specialised stores" },
    { code: "47791", description: "Retail sale of antiques including antique books" },
    { code: "47799", description: "Retail sale of other second-hand goods" },
    ...
    { code: "49311", description: "Urban and suburban passenger railway transportation" },
    { code: "49319", description: "Other urban and suburban passenger land transport" },
    ...
    { code: "52101", description: "Operation of warehousing and storage facilities for land transport" },
    { code: "52102", description: "Operation of warehousing and storage facilities for water transport" },
    { code: "52103", description: "Operation of warehousing and storage facilities for air transport" },
    ...
    { code: "52213", description: "Operation of bus and coach passenger facilities" },
    ...
    { code: "52242", description: "Cargo handling for land transport activities" },
    { code: "52243", description: "Cargo handling for air transport activities" },
    ...
    { code: "53202", description: "Unlicensed carriers" },
    ...
    { code: "64921", description: "Credit granting by non-deposit taking finance houses" },
    { code: "64922", description: "Activities of mortgage finance companies" },
    { code: "64929", description: "Other credit granting" },
    ...
    { code: "66190", description: "Other activities auxiliary to financial intermediation" },
    ...
    { code: "70229", description: "Other management consultancy activities" },
    ...
    { code: "72190", description: "Other research and experimental development on natural sciences" },
    ...
    { code: "74209", description: "Other photographic activities" },
    ...
    { code: "74909", description: "Other professional, scientific and technical activities" },
    { code: "74990", description: "Other professional, scientific and technical activities" },
    ...
    { code: "77320", description: "Renting and leasing of construction and civil engineering machinery" },
    { code: "77330", description: "Renting and leasing of office machinery and equipment" },
    ...
    { code: "77390", description: "Renting and leasing of other machinery, equipment and tangible goods" },
    { code: "77400", description: "Leasing of intellectual property and similar products" },
    { code: "78101", description: "Motion picture, television and other theatrical casting" },
    ...
    { code: "79901", description: "Tourism activities" },
    { code: "79909", description: "Other reservation service activities" },
    ...
    { code: "82190", description: "Photocopying, document preparation and other office support activities" },
    ...
    { code: "84120", description: "Regulation of health care, education, cultural and other social services" },
    ...
    { code: "85590", description: "Other education" },
    ...
    { code: "87200", description: "Residential care for learning disabilities, mental health and substance abuse" },
    ...
    { code: "88990", description: "Other social work activities without accommodation" },
    ...
    { code: "96090", description: "Other personal service activities" },
    { code: "97000", description: "Activities of households as employers of domestic personnel" },
    { code: "98000", description: "Undifferentiated goods-producing activities of private households" },
    { code: "98200", description: "Undifferentiated service-producing activities of private households" },
